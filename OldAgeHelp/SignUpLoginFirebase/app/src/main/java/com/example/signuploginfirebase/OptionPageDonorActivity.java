...
public class OptionPageDonorActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.option_page_donor);
        ...
        findViewById(R.id.adopt).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),Adopter.class);
                startActivity(intent);
                finish();
        ...
        findViewById(R.id.btnLogoutD).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OptionPageDonorActivity.this);
                ...
                builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
                    ...
                    Toast.makeText(OptionPageDonorActivity.this, "Signing out...", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(OptionPageDonorActivity.this, login.class);
                    startActivity(intent);
                    finish();
                });
